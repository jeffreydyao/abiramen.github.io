...
{: .alert}
If you're a VS Code user who is in first year, or isn't too used to coding locally, you might be better off checking the easier method of using SSHFS with VS Code [here](/cse-seutp).
...
* WSL, which you can learn about setting up [here](/wsl-github){: target="_blank"}. [^3]
